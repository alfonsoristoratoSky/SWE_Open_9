...
describe("User class", () => {
    beforeAll(()=> {
        user1 = new User('Alfo', '1991-04-03', 4444333322221111, '1022', '033')
    })
    ...
    test('cvc cannot be a number with leading 0s', () => {
        expect(() => new User('Alfo', '1991-04-03', 4444333322221111, '1022', parseInt('033')))
        .toThrowError('CVC must be of 3 digits only')
    })
