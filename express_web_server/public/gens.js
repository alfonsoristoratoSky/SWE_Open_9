...
function fillDivs(){
    //let div = document.getElementById('divToUSe')
    let thirdGenDiv = document.getElementById('thirdGenDiv')
    
    
    thirdGen.forEach(e => {
      thirdGenDiv.insertAdjacentHTML('afterend',`<div> Name: <a href='./royal/${e.name}'> ${e.name}</a></div></br>`
      // "<div> Parents: " + e.parents + "</div>",
      )  
...
module.exports = {Person, firstGen, secondGen, thirdGen, fillDivs}